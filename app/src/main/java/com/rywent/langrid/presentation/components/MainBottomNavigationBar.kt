package com.rywent.langrid.presentation.components
...
import com.rywent.langrid.presentation.navigation.Screen
import com.rywent.langrid.presentation.navigation.mainRouteIndex
import com.rywent.langrid.presentation.navigation.navigateToTopLevelSafely
...
fun MainBottomNavigationBar(
    ...
    val bottomTabs = listOf(
        ...
        BottomBarItem(
            ...
            selectedIcon = Icons.Rounded.AutoAwesomeMosaic,
            label = "Cards"
        ),
        BottomBarItem(
            screen = Screen.Words,
            icon = Icons.Outlined.BackupTable,
            selectedIcon = Icons.Rounded.BackupTable,
            label = "Words"
        ),
        BottomBarItem(
            screen = Screen.Diary,
